...
const insertSchedule = (user_id, church_id) => {
    return pool.query("INSERT INTO public schedule_drop_off (user_id,church_id) VALUES($1, $2) RETURNING *", [user_id, church_id]).then(result => { return result.rows[0] });
}
module.exports = {
    getListing,
    changeStatus,
